...
public class Fly extends Entity {
	...
	private static BufferedImage[] sprites = {
			Game.spritesheet.getSprite(321+(tileSize*0), 33, tileSize, tileSize),
			Game.spritesheet.getSprite(321+(tileSize*1), 33, tileSize, tileSize)
	};

	private double speed = 0.1;
	
	public Fly(int x, int y, int width, int height, BufferedImage sprite) {
